            ...
            className='min-h-screen w-full lg:w-[60rem] pt-12 px-6 sm:pt-10 sm:px-10'>
                ...
                >
                    ...
                    <div 
                        ...
                        id="main-text" 
                        name="main-text" 
                        className='outline-none text-slate-400 text-md sm:text-xl caret-cyan-200 leading-loose tracking-wide selection:bg-teal-400 selection:text-slate-100 selection:bg-opacity-20 bg-transparent w-[100%] text-opacity-40 focus:text-opacity-100 placeholder:text-slate-400 placeholder:text-opacity-20 placeholder:focus:text-opacity-10 resize-none inline-block'
